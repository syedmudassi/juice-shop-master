...
import { ScanStatusDashboardComponent } from './scan-status-dashboard/scan-status-dashboard.component'
import { VulnerabilityScanningFrameworkComponent } from './vulnerability-scanning-framework/vulnerability-scanning-framework.component'
...
const routes: Routes = [
  ...
  {
    path: 'scan-status-dashboard',
    component: ScanStatusDashboardComponent
  },
  {
    path: 'vulnerability-scanning-framework',
    component: VulnerabilityScanningFrameworkComponent
  },
  {
    path: 'address/select',
